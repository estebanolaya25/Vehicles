    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return View(await _context.Users
                .Include(x =>x.DocumentType).Include(x=>x.Vehicles)
                .Where (x => x.UserType==Vehicles.Common.Enums.UserType.User)
                .ToListAsync());
        }
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            Vehicle.API.Data.Entities.Vehicle vehicle = await _converterHelper.ToVehicleAsync(vehicleViewModel, true);
